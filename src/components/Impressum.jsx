  ...
  return (
    <div className='impressum'>
      ...
      <div className='impressum-content'>
        ...
        Vertreten durch: Pauline Margossian<br></br>
        Berlin, Deutschland <br></br>
        E-Mail: <a href='mailto:paulinemargossian@gmail.com'>paulinemargossian@gmail.com</a><br></br>
        Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:<br></br>
        Pauline Margossian<br></br>
        <div className='haftung-inhalt'>
