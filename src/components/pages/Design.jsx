      ...
      <h1>Why UI Design?</h1>
        ...
        <div className="article-content">
          <div className='indent'>
            After finishing Full-Stack, I have decided to enrol again at CareerFoundry in the <a href='https://careerfoundry.com/en/courses/become-a-ui-designer/'>UI Design</a>, to better design the websites I am developing. 
          ...
          <div className='indent'>
            As part of UX, I have learned about design processes, user psychology, conducting user research, creating user personas and user stories, lean UX, user flows and diagram, exploratory sketching, rapid prototyping and user testing.
          </div>
          <div className='indent'>
